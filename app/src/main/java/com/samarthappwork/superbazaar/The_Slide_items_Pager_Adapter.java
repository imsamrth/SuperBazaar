...
public class The_Slide_items_Pager_Adapter extends PagerAdapter {
    ...
    Context Mcontext ;
    List<the_slide_item_model_class> theSlideItemsModelClassList ;


    public The_Slide_items_Pager_Adapter(Context Mcontext, List<the_slide_item_model_class> theSlideItemsModelClassList) {
    ...
    public Object instantiateItem(@NonNull ViewGroup container, int position) {
        ...
        View sliderLayout = inflater.inflate(R.layout.slideshow_layout,null);

        ImageView featured_image = sliderLayout.findViewById(R.id.iv_main_activity_slide);
