package com.samarthappwork.superbazaar.Util;
/*
...
import com.samarthappwork.superbazaar.Constants;
...
public class PaymentsUtil {
    ...
    private static JSONObject getBaseCardPaymentMethod() throws JSONException {
        ...
        parameters.put("allowCreditCards", false);
...
//    }
    ...
    private static JSONObject getTransactionInfo(String price) throws JSONException {
        ...
        // todo setup unique transid
        transactionInfo.put("transactionId", loggined_user_details.getCustomer().getCustomer_id());
    ...
    private static JSONObject getMerchantInfo() throws JSONException {
        return new JSONObject().put("merchantName", "Super Bazaar");
    }
